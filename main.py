...
def help(update, context):
    update.message.reply_text('LORD Bot 🦎 Əmrlər:\n' +
...
def command_start(update, context: CallbackContext):
    if update.effective_chat.type == "private":
        ...
        addme = InlineKeyboardButton(text="🦎 Məni Qrupa əlavə et!", url="https://t.me/Lordgame1_bot?startgroup=a")
        kanal = InlineKeyboardButton(text="📣 Rəsmi Kanal", url="https://t.me/texnoteamm")
        admin = InlineKeyboardButton(text="🧑‍💻 Sahib", url="https://t.me/TTteamabasof")
        
        keyboard = [[addme],[kanal],[admin]]
        reply_markup = InlineKeyboardMarkup(keyboard)
        update.message.reply_text('Salam Mən LORD Söz Oyunu Bot\nMəni Grupa Qataraq Oyun Başlada Bilərsiniz\n\nDaha ətraflı /help', reply_to_message_id=True, reply_markup=reply_markup)
    else:
        ...
        update.message.reply_text('LORD Söz Oyunu Başladi!🦎'.format(username), reply_to_message_id=True)
